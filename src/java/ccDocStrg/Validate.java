...
/**
 *
 * @author Muhammad Wannous This Servlet accepts two parameters for the user
 * name password It uses the parameters to validate a registered user.
 */
public class Validate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!userName.isEmpty() && !passWord.isEmpty()) {
            ...
            //Run the query.
            List<Entity> dbDate = datastore.prepare(dateQuery).asList(FetchOptions.Builder.withDefaults());
            ...
            if (!dbUsers.isEmpty()) {
                ...
                User user = new User((String) userEntity.getProperty(Defs.ENTITY_PROPERTY_FIRSTNAME_STRING),
                        ...
                        "",
                        (String) userEntity.getProperty(Defs.ENTITY_PROPERTY_REGISTER_DATE));

                Date today = new Date();
                SimpleDateFormat DateFormat = new SimpleDateFormat("EEE, d MMM yyyy HH:mm:ss ");
                String lastDate = DateFormat.format(today);
                Entity dateEntity = new Entity(Defs.DATASTORE_KIND_DATE_STRING);
                dateEntity.setProperty(Defs.ENTITY_PROPERTY_USERNAME_STRING, userEntity.getProperty(Defs.ENTITY_PROPERTY_USERNAME_STRING));
                dateEntity.setProperty(Defs.ENTITY_PROPERTY_DATE_DATE, lastDate);
