...
//String lastDate = formatter.format(formatter);
      //The input is valid.
      User newUser = new User("", "", userName, passWord, lastDate);
      ...
      if (dbUsers.isEmpty()) {
        ...
        userEntity.setProperty(Defs.ENTITY_PROPERTY_REGISTER_DATE, newUser.getLastDate());
